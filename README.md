...
Este repositorio contiene un taller práctico desarrollado para la asignatura de **Paradigmas de Programación**. El proyecto es un videojuego 2D diseñado para aplicar de forma práctica los conceptos de programación orientada a objetos, estructuración lógica y arquitectura de nodos utilizando Godot Engine y C#.

---

## 📖 Descripción

[Agrega aquí un párrafo breve de 2 a 3 líneas describiendo de qué trata tu juego. Por ejemplo: "Es un juego de exploración y plataformas donde el jugador debe sortear obstáculos aplicando mecánicas de movimiento fluido y organización espacial".]
